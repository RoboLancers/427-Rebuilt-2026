...
public class LEDSubsystem extends SubsystemBase {
  ...
  // LEDPattern m_rainbow = breathe.scrollAtAbsoluteSpeed(Centimeters.per(Seconds).of(12.5),
  // kLedSpacing);
  ...
  // final LEDPattern xSpeed = LEDPattern.progressMaskLayer(() -> scaledInputs.getX() /
